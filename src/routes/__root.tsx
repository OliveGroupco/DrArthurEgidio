...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Dr. Arthur Egídio" },
      ...
      { name: "twitter:title", content: "Dr. Arthur Egídio — Odontologia Integrada" },
      { name: "twitter:description", content: "Clínica odontológica premium com implantes, ortodontia, lentes de contato dental e estética do sorriso. Tecnologia, precisão e atendimento humanizado." },
    ],
    links: [
      {
        rel: "stylesheet",
